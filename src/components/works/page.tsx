...
const Jobspage = () => {
  ...
  return (
    <section
      className="container mx-auto p-6 max-w-7xl text-white bg-gradient-to-r bg-[#1e1e28]  rounded-lg shadow-lg ransform transition duration-500 ease-in-out hover:-translate-y-1 hover:scale-10"
      id="trabalhos"
    >
      ...
      <div className="flex flex-col items-center space-y-6 md:space-y-0 md:flex-row md:space-x-6">
        <AnimatePresence initial={false} custom={direction}>
          <motion.div
            ...
            className="bg-[#1e1e28] h-[28rem]  p-4 rounded-lg shadow-lg flex flex-col items-center responsive-work-container"
          >
            <div className="flex flex-row items-center space-y-6 responsive-work gap-5 ">
              <div className="w-full mb-4  bg-red-900">
                <Image
                  src={image}
                  alt={title}
                  width={800}
